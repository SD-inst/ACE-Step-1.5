...
from acestep.gpu_config import get_gpu_memory_gb, get_lm_gpu_memory_ratio, get_global_gpu_config
...
class LLMHandler:
    ...
    def generate_from_formatted_prompt(
        ...
        elif self.llm_tokenizer is None:
            return "", "❌ 5Hz LM is missing tokenizer."
